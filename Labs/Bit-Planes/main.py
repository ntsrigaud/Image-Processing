...
If we take a grayscale image and convert it to a matrix of type double, we can perform arithmetic on the values. Thus, we can isolate the bit planes simply by dividing the obtained matrix by successive powers of 2, throwing away the remainder and seeing if the final bit is 0 or 1.
